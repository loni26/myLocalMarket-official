...
export class AddProductComponent implements OnInit {
  ...
  constructor(private _fb: FormBuilder, private ps: ProductService ) { }
 

  ngOnInit(): void {
    this.productForm = this._fb.group({
      productName: ['', [Validators.required,Validators.pattern('[a-zA-Z ]*'),Validators.minLength(8), Validators.maxLength(80)]],
      description: ['', [Validators.required,Validators.pattern('[a-zA-Z ]*'), Validators.minLength(8), Validators.maxLength(80)]],
